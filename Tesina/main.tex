...
\include{Dataset_Originale}
\include{scelta_architetturale}
\include{inserimento_dati_collegamento}
\include{processing}
\include{influence_maximization}
\include{analisi_dei_risultati}
\end{document}
